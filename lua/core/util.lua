...
---@alias ComfyProfile {data: string|{[string]:string}, time: number, [number]:ComfyProfile}
...
function M.very_lazy()
  local function _load()
    vim.schedule(function()
      ...
      vim.api.nvim_exec_autocmds("User", { pattern = "VeryComfy", modeline = false })
    end)
  end
...
---@alias ComfyNotifyOpts {lang?:string, title?:string, level?:number, once?:boolean, stacktrace?:boolean, stacklevel?:number}

---@param msg string|string[]
---@param opts? ComfyNotifyOpts
